...
var Calendar = function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderDay() {
      ...
      console.log("DAY OF MONTH ==>", opts.date.getDate(), this.props.eventsBool[opts.date.getDate() - 1]);
      return _react2.default.createElement(
        "div",
        { key: opts.key, className: baseClasses, style: containerStyle },
        _react2.default.createElement("div", {
          className: today + " " + (this.props.eventsBool[opts.date.getDate()] && opts.current ? "hasEvent" : ""),
          style: todayStyle
        }),
