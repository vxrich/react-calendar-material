  ...
  _createClass(Calendar, [{
    ...
    value: function _onDatePicked(month, day) {
      ...
      if (this.props.onDateRangePicked && this.state.inMidOfSelection) {
        this.setState({
          current: d,
          selected: this.state.selected[0].getDate() > d.getDate() || this.state.selected[0].getMonth() > d.getMonth() ? [d, this.state.selected[0]] : [this.state.selected[0], d],
          inMidOfSelection: false
        }, function () {
    ...
    value: function renderDay() {
      ...
      baseClasses += opts.current ? "" : !opts.inrange && !opts.selected[0] && !opts.selected[1] && " non-current";
    ...
    value: function renderDays(copy) {
      ...
      for (var i = 0; i < 42; i++) {
        ...
        console.log(copy.getMonth(), sel1.getMonth(), sel2.getMonth(), " --- ", copy.getDate(), sel1.getDate(), sel2.getDate());
